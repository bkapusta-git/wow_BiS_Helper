...
- **Enhanced gear columns**
  - **Enchant** — rates your enchant against the one recommended for your spec: green when it matches at max rank, flagged when it is a lower crafting rank, outside the season catalogue, or missing. On slots whose enchants grant stats your spec does not rank, it shows what you wear instead of guessing. The tooltip names the stat and what the enchant is worth on that item.

-- BiS data: Discipline Priest — Midnight Season 2
...
BiSHelper_Data["PRIEST_DISCIPLINE"] = {
    ...
    content = {
        ...
        raid = {
            ...
            [3]= { itemID = 271553, name = "Cosmic Penitent's Echoing Screams",source = "Vexhul"                            }, -- Shoulder
            [5]= { itemID = 271558, name = "Cosmic Penitent's Eclipsing Robes",source = "Murder Row"                        }, -- Chest
            [6]= { itemID = 239649, name = "Martyr's Waistwrap",               source = "Crafting"                          }, -- Waist
            [7]= { itemID = 271554, name = "Enveloping Legwraps of the Cosmic Penitent",source = "Sszorak"                           }, -- Legs
            [8]= { itemID = 268255, name = "Cackling Soultreads",              source = "Hex Lord Malacrass"                }, -- Feet
            ...
            [15]= { itemID = 268253, name = "Silken Voodoo Drape",              source = "Hex Lord Malacrass"                }, -- Back
